...
export default function UserBooking({ myObject , resources , updateUser , deleteEvent}) {
  ...
  return (
    ...
    >
      ...
      <p className="font-semibold text-xs mb-1">
        <FontAwesomeIcon className="text-xs p-0" icon={faUser} /> {startTime} -       <p className="font-semibold text-xs">{endTime}</p>
