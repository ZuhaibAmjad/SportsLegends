...
export default function UpdateProfileAdmin() {
  ...
  const getUserdata = (e) => {
    const { name, value } = e.target; // Capture name and value from the input field
  ...
  const sendData = async (e) => {
    e.preventDefault();
    const { email, password, phone, lastName, firstName } = updateUser;
    try {
        ...
        <div className="w-100 px-4 h-[100vh] overflow-y-scroll">
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-x-3 m-2 mt-2 p-3">
            <div className="">
              ...
              <button
                className={`flex p-3 space-x-3  w-100  ${
                  Show ? "bg-gray-300" : ""
                }`}
                onClick={handleShowComponent1}
              >
                <div className="">
                ...
                <div className="">
                  ...
                  <p className="text-sm">
                    An Ical link to use in your other calender{" "}
                  </p>
                </div>
              </button>
            ...
            {Show ? (
              <div className="lg:col-span-2 md:col-span-1 max-w-xl sm:mt-4 xs:mt-4">
                  ...
                  <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-x-3 m-2 mt-2">
                    ...
                    <div className="my-3">
                      ...
                      <input
                        type="text"
                        name="password"
                        value={updateUser && updateUser.password}
                        onChange={getUserdata}
                  ...
                  <div className="grid lg:grid-cols-2 md:grid-cols-1 gap-x-3  my-2">
                    <div className="my-3">
                      ...
                      <input
                        type="text"
                        name="firstName"
                        value={updateUser && updateUser.firstName}
                        onChange={getUserdata}
                        class="form-control my-1 rounded-0 p-2 "
                        id="exampleInputEmail1"
                        aria-describedby="emailHelp"
                    ...
                    <div className="my-3">
                      ...
                      <input
                        type="email"
                        name="lastName"
                        value={updateUser && updateUser.lastName}
                        onChange={getUserdata}
                        class="form-control my-1 rounded-0 p-2"
                        id="exampleInputEmail1"
                        aria-describedby="emailHelp"
                    ...
                    <div className="my-3">
                      ...
                      <input
                        type="email"
                        value={updateUser && updateUser.organization}
                        // onChange={getUserdata}
                        class="form-control my-1 rounded-0 p-2"
                        id="exampleInputEmail1"
                        aria-describedby="emailHelp"
                ...
                <div className="">
                  ...
                  <button onClick={sendData} className="my-4 bg-green-500 text-white p-2">
                    Save All Changes
                  </button>
                </div>
              </div>
